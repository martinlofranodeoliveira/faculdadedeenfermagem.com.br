  ...
  sections: [
    {
      ...
      paragraphs: [
        'Esta politica se aplica ao site da Faculdade de Enfermagem, formularios de captacao, paginas de campanhas e canais de atendimento vinculados a nossa instituicao.',
    ...
    },
    {
      title: '10. Contato',
      paragraphs: [
        'Para exercer seus direitos ou esclarecer duvidas sobre privacidade e protecao de dados, entre em contato pelo e-mail contato@faculdadedeenfermagem.com.br.',
      ],
    },
  ],
}
...
export const termsContent: LegalContent = {
  ...
  intro:
    'Estes Termos de Uso definem as regras para navegacao e utilizacao dos canais digitais da Faculdade de Enfermagem.',
  lastUpdatedLabel: 'Ultima revisao',
  effectiveDate: '15/01/2025',
  sections: [
    {
    ...
    },
    {
      ...
      paragraphs: [
        'Todo o conteudo do site, incluindo textos, marcas, logotipos, imagens, layout e componentes visuais, pertence a Faculdade de Enfermagem ou a terceiros licenciantes.',
    ...
    },
    {
      ...
      paragraphs: [
        'Estes Termos sao regidos pela legislacao brasileira. Para duvidas, fale com nossa equipe em contato@faculdadedeenfermagem.com.br.',
      ],
    },
  ],
}
