...
export function CourseSection() {
  ...
  return (
    <section id="cursos" className="lp-lead">
      <div className="lp-lead__inner">
        ...
        {showStepOneInlineError && stepOneInlineErrorMessage ? (
          <small className="lp-lead__status lp-lead__status--error">{stepOneInlineErrorMessage}</small>
        ) : null}

        {submitMessage && !showStepOneInlineError ? (
          <small
            className={`lp-lead__status ${submitStatus === 'error' ? 'lp-lead__status--error' : ''}`}
          >
            {submitMessage}
          </small>
        ) : null}
